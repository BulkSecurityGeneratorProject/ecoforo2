...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ecoforo2@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ecoforo2 API";

        private String description = "ecoforo2 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ecoforo2";
